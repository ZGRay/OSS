...
public class HFileStorageMemche implements IStorage {
    ...
    public HFileStorageMemche(File rootDirectory, int maxMemCacheSize, int maxCacheSizeInBytes) {
        this.maxMemCacheSize = maxMemCacheSize;
        fileStorage = new FileStorage(rootDirectory, maxCacheSizeInBytes);
        initialize();
    }

    public HFileStorageMemche(File rootDirectory, int maxMemCacheSize) {
        this.maxMemCacheSize = maxMemCacheSize;
        fileStorage = new FileStorage(rootDirectory);
        initialize();
    }

    public HFileStorageMemche(File rootDirectory) {
