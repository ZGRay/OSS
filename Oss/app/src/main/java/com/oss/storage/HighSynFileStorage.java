 ...
 */
public class HighSynFileStorage implements IStorage {
...
//    private ReadWriteLock orwl = new ReentrantReadWriteLock();
    ...
    public HighSynFileStorage(File rootDirectory, int maxCacheSizeInBytes) {
        fileStorage = new FileStorage(rootDirectory, maxCacheSizeInBytes);
        initialize();
    }

    public HighSynFileStorage(File rootDirectory) {
